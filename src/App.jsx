    ...
    <div className="app-wrapper">
      ...
      <section className="section flex-center" style={{ minHeight: '100vh', paddingTop: '10rem', paddingBottom: '6rem' }}>
        <div className="container" style={{ position: 'relative', zIndex: 10 }}>
          ...
          <div style={{ marginTop: '6rem', position: 'relative', height: '480px', display: 'flex', justifyContent: 'center', maxWidth: '900px', margin: '6rem auto 0 auto' }}>
            ...
            {/* Animated Ecosystem SVG Background Connections */}
            ...
            <motion.div 
               ...
               className="ui-card" style={{ position: 'absolute', top: '20px', left: 0, width: '280px', height: '220px', zIndex: 2, background: 'var(--bg-secondary)', border: '1px solid var(--border-light)', boxShadow: '0 20px 40px rgba(0,0,0,0.8)', padding: '1.5rem' }}
            >
               ...
               <div className="ui-text-bold" style={{ fontSize: '2rem', marginBottom: '1rem' }}>₹24,50k <span style={{ color: 'var(--accent-green)', fontSize: '1rem', fontWeight: 'normal' }}>+12%</span></div>
            ...
            {/* Mobile App (Center piece) */}
             <motion.div 
               ...
               className="device-frame" style={{ width: '300px', height: '620px', zIndex: 10, position: 'absolute', bottom: '-80px', background: 'var(--bg-primary)', boxShadow: '0 30px 60px rgba(0,0,0,0.9)' }}
            >
              <PhoneCarousel />
            </motion.div>
            ...
            <motion.div 
               ...
               className="device-frame" style={{ position: 'absolute', top: '20px', right: 0, width: '280px', height: '260px', borderRadius: '24px', zIndex: 3, border: '6px solid #282D42', boxShadow: '0 20px 40px rgba(0,0,0,0.8)' }}
            >
               <AppVendingUI />
            </motion.div>
          </div>
      ...
      <section className="section" style={{ borderTop: '1px solid var(--border-light)' }}>
        <div className="container" style={{ textAlign: 'center' }}>
          ...
          <div style={{ position: 'relative', width: '100%', maxWidth: '1000px', margin: '4rem auto 0 auto', padding: '2rem 0', display: 'flex', justifyContent: 'space-between', alignItems: 'center', minHeight: '300px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', zIndex: 2 }}>
                <MotionCard index={2} style={{ padding: '1.5rem', width: '220px', textAlign: 'center', background: 'var(--bg-secondary)', border: '1px solid var(--border-light)', display: 'flex', alignItems: 'center', gap: '1rem' }}>
                   <LayoutDashboard size={24} color="var(--accent-purple)"/>
                   <div className="ui-text-bold" style={{ fontSize: '1rem' }}>Gym Admin</div>
                </MotionCard>
                <MotionCard index={3} style={{ padding: '1.5rem', width: '220px', textAlign: 'center', background: 'var(--bg-secondary)', border: '1px solid var(--border-light)', display: 'flex', alignItems: 'center', gap: '1rem' }}>
            ...
            <div style={{ marginTop: '10rem', position: 'relative', padding: '6rem 0', background: 'radial-gradient(ellipse at center, rgba(144, 65, 255, 0.1) 0%, rgba(0,0,0,0) 70%)', borderRadius: '40px', border: '1px solid rgba(144, 65, 255, 0.1)' }}>
               <div style={{ textAlign: 'center', maxWidth: '800px', margin: '0 auto 6rem auto' }}>
                  ...
                  <motion.p initial={{ opacity:0, y:20 }} whileInView={{ opacity:1, y:0 }} viewport={{ once:true }} transition={{ delay: 0.2 }} style={{ fontSize: '1.25rem', color: 'var(--text-secondary)' }}>
                    The Yuguyu Smart Vending Machine isn't just a fridge. It's a high-margin nutrition center connected directly to member workout profiles and gym ledgers.
                  </motion.p>
               </div>

               <div style={{ display: 'grid', gridTemplateColumns: 'minmax(400px, 1fr) 1fr', gap: '6rem', alignItems: 'center', padding: '0 4rem' }}>
                  ...
                  <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once:true }} transition={{ type: 'spring', stiffness: 50 }} style={{ position: 'relative', display: 'flex', justifyContent: 'center' }}>
                     <div style={{ width: '380px', height: '650px', background: 'linear-gradient(145deg, #1A1C23, #0A0A0E)', borderRadius: '32px', border: '4px solid #282D42', boxShadow: '0 40px 100px rgba(0,0,0,0.8), inset 0 2px 20px rgba(255,255,255,0.05)', display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '1.5rem', position: 'relative', overflow: 'hidden' }}>
                        ...
                        <div style={{ width: '100%', height: '65%', background: 'rgba(0,0,0,0.6)', borderRadius: '16px', border: '2px solid #111', boxShadow: 'inset 0 10px 40px rgba(0,0,0,0.9)', position: 'relative', overflow: 'hidden' }}>
                           {/* Shelf 1 */}
                           <div style={{ position: 'absolute', top: '33%', left: 0, width: '100%', height: '6px', background: '#111', boxShadow: '0 10px 20px rgba(0,0,0,0.8)' }}></div>
                           {/* Shelf 2 */}
                  ...
                  <motion.div initial={{ opacity: 0, x: 50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once:true }}>
                     ...
                     <div style={{ display: 'flex', flexDirection: 'column', gap: '3rem' }}>
                         <div>
                            <h4 style={{ fontSize: '1.5rem', marginBottom: '0.5rem' }}>Auto-synced with Diet Logs</h4>
                            <p style={{ color: 'var(--text-secondary)' }}>Members scan their app, take a protein shake, and the macros are automatically added to their Yuguyu Diet Tracker. No manual entry.</p>
                         </div>
                         <div>
                            <h4 style={{ fontSize: '1.5rem', marginBottom: '0.5rem' }}>Direct App Billing</h4>
                            <p style={{ color: 'var(--text-secondary)' }}>Purchases are charged directly to the card on file. No need for Apple Pay, credit cards, or cash at the machine.</p>
                         </div>
                         <div>
                            <h4 style={{ fontSize: '1.5rem', marginBottom: '0.5rem' }}>Live Inventory Dashboard</h4>
                            <p style={{ color: 'var(--text-secondary)' }}>You know exactly what sells, when to restock, and how much high-margin revenue the machine generated today right from the Admin panel.</p>
                         </div>
                     </div>
                  </motion.div>
               </div>
      ...
      <section className="section" style={{ borderTop: '1px solid var(--border-light)', overflow: 'hidden', padding: '10rem 0' }}>
        <div className="container" style={{ textAlign: 'center' }}>
          ...
          <div style={{ position: 'relative', height: '450px', display: 'flex', alignItems: 'center', justifyContent: 'center', maxWidth: '1000px', margin: '0 auto' }}>
            ...
            >
               <Database size={80} color="var(--text-primary)" />
               <div style={{ position: 'absolute', bottom: '-40px', fontWeight: 'bold', color: 'var(--text-primary)', letterSpacing: '1px', textTransform: 'uppercase', fontSize: '0.8rem' }}>Infrastructure Core</div>
            </motion.div>

            {/* SVG Data Stream Lines */}
            ...
            <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once:true }} className="ui-card" style={{ position: 'absolute', top: 0, left: '5%', padding: '1.5rem', background: 'rgba(11,11,15,0.8)', border: '1px solid var(--accent-green)', borderRadius: '16px' }}>
            ...
            <motion.div initial={{ opacity: 0, x: 50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once:true }} className="ui-card" style={{ position: 'absolute', top: 0, right: '5%', padding: '1.5rem', background: 'rgba(11,11,15,0.8)', border: '1px solid var(--accent-purple)', borderRadius: '16px' }}>
            ...
            <motion.div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once:true }} className="ui-card" style={{ position: 'absolute', bottom: 0, padding: '1.5rem', background: 'rgba(11,11,15,0.8)', border: '1px solid var(--accent-orange)', borderRadius: '16px' }}>
      ...
      <section className="section" style={{ background: 'var(--bg-secondary)', borderTop: '1px solid #111', padding: '10rem 0' }}>
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem' }}>
             {[
               { title: 'Higher Retention', desc: 'Pre-churn detection models identify at-risk members before they cancel, allowing for automated win-back campaigns.', icon: <Users color="var(--accent-purple)"/> },
               { title: 'New Revenue', desc: 'In-gym smart vending and integrated diet logs create high-margin nutrition revenue streams without manual labor.', icon: <DollarSign color="var(--accent-green)"/> },
               { title: 'Data Assets', desc: 'Your gym stops being a physical box and starts being a data platform, increasing the enterprise value of your business.', icon: <Database color="var(--accent-blue)"/> },
               { title: 'Full Automation', desc: 'From door access control to inventory management, Yuguyu automates the repetitive work so you can focus on training.', icon: <Settings color="#fff"/> }
             ].map((item, i) => (
                <motion.div 
                  key={i}
                  initial={{ opacity: 0, y: 30 }}
                  ...
                  style={{ display: 'flex', gap: '2rem', padding: '3rem', border: '1px solid rgba(255,255,255,0.05)', background: 'rgba(11,11,15,0.4)', alignItems: 'flex-start', borderRadius: '24px' }}
                >
                   <div style={{ background: 'var(--bg-tertiary)', padding: '1rem', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.1)' }}>{item.icon}</div>
                   <div>
                      <h3 style={{ fontSize: '1.5rem', marginBottom: '1rem' }}>{item.title}</h3>
                      <p style={{ color: 'var(--text-secondary)', fontSize: '1rem' }}>{item.desc}</p>
                   </div>
                </motion.div>
             ))}
          </div>
      ...
      <section className="section" style={{ background: '#050508', padding: '12rem 0', position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="container" style={{ textAlign: 'center', position: 'relative', zIndex: 10 }}>
          ...
          <div style={{ display: 'flex', gap: '1.5rem', justifyContent: 'center' }}>
            <button className="btn btn-primary" style={{ padding: '1.4rem 4rem', fontSize: '1.1rem' }}>Get Started Now <ArrowRight size={20} style={{ marginLeft: '12px' }} /></button>
            <button className="btn btn-secondary" style={{ padding: '1.4rem 4rem', fontSize: '1.1rem' }}>Partner Inquiry</button>
          </div>
        </div>
      </section>

      {/* FOOTER */}
      <footer style={{ padding: '6rem 4rem 4rem 4rem', borderTop: '1px solid #111', background: '#0B0B0F' }}>
         <div className="container" style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: '4rem' }}>
            ...
            <div>
               <div className="ui-text-bold" style={{ marginBottom: '1.5rem', fontSize: '1rem' }}>Platform</div>
            ...
            <div>
               <div className="ui-text-bold" style={{ marginBottom: '1.5rem', fontSize: '1rem' }}>Company</div>
               <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '0.75rem', color: 'var(--text-tertiary)', fontSize: '0.9rem' }}>
                  <li>About Us</li>
                  <li>Partners</li>
                  <li>Careers</li>
            ...
            <div>
               <div className="ui-text-bold" style={{ marginBottom: '1.5rem', fontSize: '1rem' }}>Social</div>
               <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '0.75rem', color: 'var(--text-tertiary)', fontSize: '0.9rem' }}>
                  <li>Twitter</li>
                  <li>LinkedIn</li>
                  <li>Instagram</li>
         ...
         <div className="container" style={{ marginTop: '6rem', paddingTop: '2rem', borderTop: '1px solid rgba(255,255,255,0.03)', display: 'flex', justifyContent: 'space-between', color: 'var(--text-tertiary)', fontSize: '0.8rem' }}>
